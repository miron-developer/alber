...
INSERT INTO Travelers2 SELECT id, contactNumber, description, creationDatetime, creationDatetime+86400*1000, creationDatetime+86400*1000*2, expireOnTopDatetime, isHaveWhatsUp, userID, travelTypeID, fromID, toID, topTypeID FROM Travelers;
